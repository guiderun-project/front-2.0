...
These guidelines apply to Claude and other automated coding agents working in this repository.
Keep `CLAUDE.md` and `AGENTS.md` aligned when changing agent instructions.
