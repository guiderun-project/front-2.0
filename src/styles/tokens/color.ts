...
export const semanticColorAliases = {
  light: {
    bg: {
      ...
      accent1: "primitive.accent.teal.a22",
      accent2: "primitive.cyan.400-a20",
    },
    text: {
    ...
    button: {
      subtle: {
        text: "primitive.cyan.500",
      },
    },
    loading: {
      skeleton: {
        base: "primitive.neutral.150",
        highlight: "primitive.neutral.75",
      },
    },
  },
  dark: {
    bg: {
      ...
      accent1: "primitive.accent.teal.a22",
      accent2: "primitive.cyan.500-a24",
    },
    text: {
    ...
    button: {
      subtle: {
        text: "primitive.cyan.400",
      },
    },
    // Figma가 dark skeleton 값을 제공하지 않아 neutral 스케일로 추론한 값이다. Figma 확정 시 교체한다.
    loading: {
      skeleton: {
        base: "primitive.neutral.850",
        highlight: "primitive.neutral.800",
      },
    },
  },
...
export const color = {
  ...
  button: {
    subtle: {
      text: "var(--color-button-subtle-text)",
    },
  },
  loading: {
    skeleton: {
      base: "var(--color-loading-skeleton-base)",
      highlight: "var(--color-loading-skeleton-highlight)",
    },
  },
} as const;
...
export const colorTokenMap = {
  ...
  "bg.accent1": "var(--color-bg-accent1)",
  "bg.accent2": "var(--color-bg-accent2)",
  ...
  "button.subtle.text": "var(--color-button-subtle-text)",
  "loading.skeleton.base": "var(--color-loading-skeleton-base)",
  "loading.skeleton.highlight": "var(--color-loading-skeleton-highlight)",
} as const;

export type ColorToken = keyof typeof colorTokenMap;

export const resolveColorToken = (token: ColorToken): ColorValue =>
  colorTokenMap[token];
