...
export const ADDITIONAL_SELECT_OPTION_DEFAULT_COUNT = 2;
export const ADDITIONAL_SELECT_OPTION_MIN_COUNT = 2;
export const ADDITIONAL_SELECT_OPTION_MAX_COUNT = 5;
export const ADDITIONAL_SELECT_OPTION_DELETABLE_START_INDEX = 2;
