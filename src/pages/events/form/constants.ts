...
export const ADDITIONAL_SELECT_OPTION_DEFAULT_COUNT = 3;
export const ADDITIONAL_SELECT_OPTION_MIN_COUNT = 3;
export const ADDITIONAL_SELECT_OPTION_MAX_COUNT = 5;
export const ADDITIONAL_SELECT_OPTION_DELETABLE_START_INDEX = 3;
export const EVENT_CONTENT_MAX_LENGTH = 500;
